(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			xlarge: { media: '(max-width: 4096px)', href: 'css/style-xlarge.css' },
			large: { media: '(max-width: 1980px)', href: 'css/style-large.css', containers: '42em', grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
